...
def windowsave():  # to open the window save....
    ...
    address = fileWindow[
        0]  # faut mettre l'extension du format genre fichier.pyc ou fichier.xls dans la barre de saisie
...
# Table
ui_mainwindow.tableWidget.read_input.connect(
    lambda x, y, string: evalutation.cellEvaluation(x, y, string, network, ui_mainwindow, knownFunctions))
